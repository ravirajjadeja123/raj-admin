...
if(isset($_REQUEST['Submit']))
{
  ...
  if(isset($id)>0 && $id!='')
  {
      ...
      {
          location(ADMIN_URL."add_field.php?msg=4&id=$id&mode=edit&client_id=$client_id&project_id=$project_id&section_id=$section_id&page_id=$page_id");
        return;
      }
  ...
  else
  {
    ...
    {
      location(ADMIN_URL."add_field.php?msg=4&client_id=$client_id&project_id=$project_id&section_id=$section_id&page_id=$page_id");
      return;
    }
...
if(isset($_REQUEST['mode']))
{
  switch($_REQUEST['mode'])
  {
    case 'delete' :
      ...
      mysqli_query($con,$query) or die(mysqli_error());
      location(ADMIN_URL."manage_field.php?client_id=$client_id&project_id=$project_id&section_id=$section_id&page_id=$page_id&msg=3");
    break;
  } 
} 
