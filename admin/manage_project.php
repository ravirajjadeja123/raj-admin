<?php 
  ...
  if(isset($_REQUEST['id'])!="" && isset($_REQUEST['status'])!="")
  {
    ...
    $sel=mysqli_query($con,"UPDATE `project` SET `status`='$status_set' WHERE `id`=".$_REQUEST['id']);
    location(ADMIN_URL."manage_project.php?msg=6");
  }
  $pagetitle="Project";
  $sel= "SELECT `project`.*,`client`.`client_name` FROM `project` INNER JOIN `client` ON `project`.`client_id`=`client`.`id` ";
                  ...
                  <tr style="text-align: left;">
                    ...
                    <td style="text-align: center;">
                      ...
                      <?php
                        if($data->status=="1")
                        {  ?>
<a class="btn btn-success btn-sm" href="#" onclick="window.location.href='manage_project.php?id=<?php echo $data->id; ?>&status=<?php echo $data->status; ?>'">
  <i class="fa fa-eye"></i>
</a>
                      <?php
                        }
                        ...
                        { 
                      ?>
<a class="btn btn-danger btn-sm" href="#" onclick="window.location.href='manage_project.php?id=<?php echo $data->id; ?>&status=<?php echo $data->status; ?>'">
  <i class="fa fa-eye-slash"></i>
                    ...
                    <td style="text-align: center;">
                      <div class="btn-group">
                        <a class="btn btn-info btn-sm" href="#" onclick="window.location.href='add_project.php?id=<?php echo $data->id; ?>&mode=edit'">
...
?>
              ...
              <a href="add_project.php" role="button" class="btn btn-primary">Add New</a>
</form>
