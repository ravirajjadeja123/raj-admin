...
if(isset($_SESSION["ADMIN_SESS_USERID"]) && $_SESSION["ADMIN_SESS_USERID"]!='')
{
...
<?php } ?>
    ...
    <form action="password.php" name="frm" method="post">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" class="ace" value="1" name="remember_me" id="remember_me"> Remember Me
            </label>
          </div>
        </div>
        <!-- /.col -->
