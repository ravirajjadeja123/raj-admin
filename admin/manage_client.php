<?php 
  ...
  if(isset($_REQUEST['id'])!="" && isset($_REQUEST['status'])!="")
  {
    ...
    $sel=mysqli_query($con,"UPDATE `client` SET `status`='$status_set' WHERE `id`=".$_REQUEST['id']);
    location(ADMIN_URL."manage_client.php?msg=6");
  }
  $pagetitle="Client";
  $sel= "SELECT * FROM `client` ORDER BY `id`" ;
                  ...
                  <tr style="text-align: left;">
                    ...
                    <td style="text-align: center;">
                      <?php
                        if($data->status=="1")
                        {  ?>
<a class="btn btn-success btn-sm" href="#" onclick="window.location.href='manage_client.php?id=<?php echo $data->id; ?>&status=<?php echo $data->status; ?>'">
  <i class="fa fa-eye"></i>
</a>
                      <?php
                        }
                        ...
                        { 
                      ?>
<a class="btn btn-danger btn-sm" href="#" onclick="window.location.href='manage_client.php?id=<?php echo $data->id; ?>&status=<?php echo $data->status; ?>'">
  <i class="fa fa-eye-slash"></i>
                    ...
                    <td style="text-align: center;">
                      <div class="btn-group">
                        ...
                        <a class="btn btn-danger btn-sm" href="add_client.php?id=<?php echo $data->id; ?>&mode=delete" onclick="return deleteConfirm();">
...
<?php $counter++;} ?>
              ...
              <a href="add_client.php" role="button" class="btn btn-primary">Add New</a>
</form>
