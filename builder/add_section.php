...
if(isset($_REQUEST['Submit']))
{
  ...
  if(isset($id)>0 && $id!='')
  {
      ...
      {
          location(BUILDER_URL."add_section.php?msg=4&id=$id&mode=edit");
          return;
      }
      ...
      location(BUILDER_URL."manage_section.php?msg=2");
  }
  else
  {
    if(GTG_is_dup_add($con,'section','section_name',$section_name))
    {
      location(BUILDER_URL."add_section.php?msg=4");
      return;
    }
    $query = "INSERT INTO `section` SET `client_id`='$client_id',`project_id`='$project_id',
  	...
  	mysqli_query($con,$query) or die(mysqli_error());
  	location(BUILDER_URL."manage_section.php?msg=1");
  }
}
...
if(isset($_REQUEST['mode']))
{
  switch($_REQUEST['mode'])
  {
    ...
    {
      location(BUILDER_URL."manage_section.php?msg=5");
    }
    else
    {
      $query = "DELETE FROM section WHERE id=".$_REQUEST['id'];     
      mysqli_query($con,$query) or die(mysqli_error());
      location(BUILDER_URL."manage_section.php?msg=3");
    }
    break;
  } 
} 
